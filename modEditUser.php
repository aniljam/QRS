  ...
  <div class="image content">
             ...
             <form class="ui form basic segment" enctype="multipart/form-data" method="POST" action="" id="myFrm">
                                    ...
                                    <?php 
                                     ...
                                     ?>
                                    <div class="ui horizontal divider">Update Role</div>
                                        <div class="two fields">
                                        <div class="field">
                                            <label>Role Name</label>
                                            <select class="ui dropdown" name="rolename" id="rolename">
                                                <option value="" selected disabled></option>
                                                <option value="3" <?php if($selUData['myuserRoleID'] == 3){echo "selected='selected'";} ?>>HR Specialist</option>
                                                <option value="2" <?php if($selUData['myuserRoleID'] == 2){echo "selected='selected'";} ?>>HR Coordinator</option>
                                                <option value="1" <?php if($selUData['myuserRoleID'] == 1){echo "selected='selected'";} ?>>Administrator</option>
                                            </select>
                                        </div>
                                          <div class="field">
                                            <label>Active ? </label>
                                            <select class="ui dropdown" name="userrolestat" id="userrolestat">
                                              <option value=""></option>
                                              <option value="1" <?php if($selUData['myuserRoleStat'] == 1){echo "selected='selected'";} ?>>YES</option>
                                              <option value="0" <?php if($selUData['myuserRoleStat'] != 1){echo "selected='selected'";} ?>>NO</option>
                                            </select>
                                          </div>
                                        </div>
