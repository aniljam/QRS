...
$userEmpIDVal = base64_decode($_GET['id']);
$selQRSaccnt = new LoggedAccount();
$selQRSaccnt -> getaccountuser($userEmpIDVal);
$selQRSaccnt -> getActiveRole($userEmpIDVal);
                ...
                <div class="row">
                    ...
                    <br />
                        <div class="col-md-8">
                            ...
                            <div class="ui pink ribbon label"><i class="fa fa-users" aria-hidden="true"></i>&nbsp; Update User </div>
                                <form class="ui form basic segment" enctype="multipart/form-data" method="POST" action="" id="myFrm">
                                    ...
                                    <div class="inline field">
                                         ...
                                         <input type="text" name="EmpNumber" id="EmpNumber" placeholder="Search Employee ID ..." onkeyup="getUser(this.value);" value="<?php echo $selQRSaccnt -> empid; ?>">
                                         
                                    </div>
                                    <div class="three fields">
                                        <div class="required field">
                                            <label>Last Name</label>
                                         <input type="text" name="LName" id="LName" value="<?php echo $selQRSaccnt -> QLName; ?>" >
                                        </div>
                                        <div class="required field">
                                            <label>First Name</label>
                                         <input type="text" name="FName" id="FName" value="<?php echo $selQRSaccnt -> QFName; ?>">
                                        </div>
                                        <div class="field">
                                            <label>Middle Name</label>
                                         <input type="text" name="MName" id="MName" value="<?php echo $selQRSaccnt -> QMName; ?>">
                                        </div>
                                    </div>
                                    <div class="two fields">
                                        <div class="required field">
                                           <label>Email Address</label>
                                           <input type="text" name="emailadd" id="emailadd" value="<?php echo $selQRSaccnt -> email; ?>">
                                       </div>
                                        <div class="field">
                                            <label>Nick Name</label>
                                            <input type="text" name="PName" id="PName" placeholder="" value="<?php echo $selQRSaccnt -> Pname; ?>"> 
                                        </div>
                                    ...
                                    <div class="two fields">
                                        <div class=" required field">
                                            ...
                                            <input type="text" name="DeptName" id="DeptName" value="<?php echo $selQRSaccnt -> Dept; ?>">
                                        </div>
                                        <div class="field">
                                        <label>Contact Number</label>
                                        <input type="text" name="CNumber" id="CNumber" value="<?php echo $selQRSaccnt -> contact; ?>">
                                        </div>
                                    ...
                                    <div class="actions">
                                        ...
                                        <div class="ui buttons">
                                          ...
                                          <a href="<?php echo $urlid; ?>">
                                            <div class="ui button" id="btnCancel">Cancel</div>
                                          </a>
